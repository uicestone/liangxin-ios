...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag('mypic', '<div class="inner" riot-style="background-image:url({opts.pic})" onclick="{toggle}"> <div class="select {selected?\'selected\':\'\'}"></div> <div class="title">{opts.title}</div> <div class="like"> <i class="icon-like"></i> <span class="count">{opts.likes}</span> </div> <div class="comment"> <i class="icon-comment"></i> <span class="count">{opts.comments}</span> </div> </div>', function(opts) {
